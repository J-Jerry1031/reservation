...
$lang->about_domain='要建立網站必須要有個專屬域名。 頂級域名或次級域名都可以。輸入時，請將 XE 安裝路徑也一起輸入。 例) www.xpressengine.com/xe';
$lang->about_vid='直接以 http://程式安裝位址/ID 的方式訪問。模組名稱(mid)不能重複。 必須要以英文字母開頭，只允許使用底線、英文及數字。';
...
$lang->about_module='除基本函式庫以外 XE 全部由模組組成。 模組管理中列出所有已安裝的模組，因此易於管理。';
...
$lang->multilingual_desc='XE 目前支援 12 種國際語言。 想添加其他語言，請將 /common/lang/ 目錄的檔案新增翻譯後，寄至 XE 開發團隊(contact@xpressengine.com)';

...
<?php require_once('./classes/xml/XmlJsFilter.class.php');$__xmlFilter=new XmlJsFilter('modules/member/m.skins/sketchbook5_member_m.skin/filter','find_member_account.xml');$__xmlFilter->compile(); ?>
<div class="border">
<section>

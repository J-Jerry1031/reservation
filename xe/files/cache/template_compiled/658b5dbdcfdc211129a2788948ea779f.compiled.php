...
<?php  
	...
	$__Context->point = $__Context->oPointModel->getPoint($__Context->member_info['member_srl']); 
 ...
 ?>
				<td class="nowr">
					<a href="#popup_menu_area" class="member_<?php echo $__Context->member_info['member_srl'] ?>" title="Info"><img src="http://www.goggg.co.kr/xe/modules/point/icons/warrock_17x17/<?php echo $__Context->level ?>.gif" height="15"><?php echo getEncodeEmailAddress($__Context->member_info['email_address']) ?></a>
				</td>

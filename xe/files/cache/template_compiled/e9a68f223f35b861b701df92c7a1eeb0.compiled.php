...
<?php require_once('./classes/xml/XmlJsFilter.class.php');$__xmlFilter=new XmlJsFilter('modules/member/m.skins/sketchbook5_member_m.skin/filter','openid_login.xml');$__xmlFilter->compile(); ?>
<div class="signin">

...
<!--#Meta:modules/editor/skins/xpresseditor2/css/default.css--><?php $__tmp=array('modules/editor/skins/xpresseditor2/css/default.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<?php if($__Context->colorset == "white_texteditor" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "white_text_nohtml" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "white_text_usehtml" || $__Context->colorset == "black_text_usehtml"){ ?>
    <!--#Meta:modules/editor/skins/xpresseditor2/js/xe_textarea.js--><?php $__tmp=array('modules/editor/skins/xpresseditor2/js/xe_textarea.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
    <?php if($__Context->colorset == "black_texteditor" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "black_text_usehtml"){ ?>
        <!--#Meta:modules/editor/skins/xpresseditor2/css/black.css--><?php $__tmp=array('modules/editor/skins/xpresseditor2/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
if($__Context->colorset == "white_texteditor" || $__Context->colorset == "white_texteditor"){ ?>br<?php } ?>" />
        <textarea id="editor_<?php echo $__Context->editor_sequence ?>" style="height:<?php echo $__Context->editor_height ?>px;" cols="10" rows="10"></textarea>
    </div>
...
<?php }else{ ?>
    ...
    <!--#Meta:modules/editor/skins/xpresseditor2/js/Xpress_Editor.js--><?php $__tmp=array('modules/editor/skins/xpresseditor2/js/Xpress_Editor.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
    <!--#Meta:modules/editor/skins/xpresseditor2/js/xe_interface.js--><?php $__tmp=array('modules/editor/skins/xpresseditor2/js/xe_interface.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
    <!-- 자동저장용 폼 -->
	...
	<?php } ?>
	<!-- 에디터 -->
	<div class="xpress-editor <?php echo $__Context->colorset ?>">
	    <div id="smart_content"> <a href="#xe_iframe" class="skip">&raquo; <?php echo $__Context->lang->edit->jumptoedit ?></a>
	    ...
	    <div class="tool">
	        ...
	        <ul class="extra1">
	            ...
	            <li class="find xpress_xeditor_ui_findAndReplace">
	                <button type="button" title="<?php echo $__Context->lang->cmd_find ?>"><span><?php echo $__Context->lang->cmd_find ?></span></button>
	                <!-- 찾기 바꾸기 레이어 -->
	                <div class="layer find xpress_xeditor_findAndReplace_layer" style="display:none">
	                <!-- class="layer find" | class="layer replace"-->
	                    <h3><?php echo $__Context->lang->edit->search_replace ?></h3>
	                    <button type="button" class="close" title="<?php echo $__Context->lang->edit->close_search_replace ?>"><span><?php echo $__Context->lang->edit->close_search_replace ?></span></button>
	                    <div class="menu_tab">
	                        <ul class="layer_tab">
	                            <li class="tab1"><a href="#find" onclick="return false"><?php echo $__Context->lang->cmd_find ?></a></li>
	                            <li class="tab2"><a href="#replace" onclick="return false"><?php echo $__Context->lang->cmd_replace ?></a></li>
	                        </ul>
	                    </div>
	                    <div class="container">
	                        <div class="bx" id="find">
	                            <fieldset>
	                                <label for="keyword1"><?php echo $__Context->lang->edit->search_words ?></label>
	                                <input id="keyword1" name="" type="text" />
	                            </fieldset>
	                            <span class="cap"></span> </div>
	                        <div class="bx" id="replace">
	                            <fieldset>
	                                <label for="keyword2"><?php echo $__Context->lang->edit->search_words ?></label>
	                                <input id="keyword2" name="" type="text" />
	                                <br />
	                                <label for="keyword3"><?php echo $__Context->lang->edit->replace_words ?></label>
	                                <input id="keyword3" name="" type="text" />
	                            </fieldset>
	                        </div>
	                    </div>
	                    <div class="btn_area">
	                        <button type="button" class="find_next" title="<?php echo $__Context->lang->edit->next_search_words ?>"><span><?php echo $__Context->lang->edit->next_search_words ?></span></button>
	                        <button type="button" class="replace" title="<?php echo $__Context->lang->cmd_replace ?>"><span><?php echo $__Context->lang->cmd_replace ?></span></button>
	                        <button type="button" class="replace_all" title="<?php echo $__Context->lang->edit->replace_all ?>"><span><?php echo $__Context->lang->edit->replace_all ?></span></button>
	                    </div>
	                    <button type="button" class="close" title="<?php echo $__Context->lang->edit->close_search_replace ?>"><span><?php echo $__Context->lang->edit->close_search_replace ?></span></button>
	                </div>
	                <!-- /찾기 바꾸기 레이어 -->
...
<!-- 에디터 -->
<ul class="xeEditor" style="margin-top:0px; margin-bottom:0px;">
        ...
        <?php } ?>
	       ...
	       <?php if($__Context->html_mode){ ?>
	        <ul class="extra3">
	            ...
	            <!--li class="preview"><span><button type="button" class="xpress_xeditor_preview_button" title="<?php echo $__Context->lang->cmd_preview ?>"><?php echo $__Context->lang->cmd_preview ?></button></span></li-->
	        </ul>
	        <?php } ?>
	    ...
	    <div id="fileUploader_<?php echo $__Context->editor_sequence ?>" class="fileUploader">
	        <div class="preview <?php echo $__Context->editor_class ?>" id="preview_uploaded_<?php echo $__Context->editor_sequence ?>"></div>
	        <div class="fileListArea <?php echo $__Context->editor_class ?>">
	        ...
	        <div class="fileUploadControl">
	            <span class="button <?php echo $__Context->editor_class ?>" id="swfUploadButton<?php echo $__Context->editor_sequence ?>"><button type="button"><?php echo $__Context->lang->edit->upload_file ?></button></span>
	            <span class="button <?php echo $__Context->editor_class ?>"><button type="button" onclick="removeUploadedFile('<?php echo $__Context->editor_sequence ?>');return false;"><?php echo $__Context->lang->edit->delete_selected ?></button></span>
	            <span class="button <?php echo $__Context->editor_class ?>"><button type="button" onclick="insertUploadedFile('<?php echo $__Context->editor_sequence ?>');return false;"><?php echo $__Context->lang->edit->link_file ?></button></span>
	        </div>
	...
	<script type="text/javascript">//<![CDATA[
	    ...
	    var oEditor = editorStart_xe("<?php echo $__Context->editor_sequence ?>", "<?php echo $__Context->editor_primary_key_name ?>", "<?php echo $__Context->editor_content_key_name ?>", "<?php echo $__Context->editor_height ?>", "<?php echo $__Context->colorset ?>", "<?php echo $__Context->content_style ?>",'<?php echo $__Context->content_font ?>');
	//]]></script>
<?php } ?>

...
$__Context->hide_file = "Y";  // 파일업로드창 숨김 여부 - Y(숨김) ,N(보임)
...
<!--#Meta:modules/editor/skins/sejin7940_editor_blank/css/default.css--><?php $__tmp=array('modules/editor/skins/sejin7940_editor_blank/css/default.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<?php if($__Context->colorset == "black" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "black_text_usehtml"){ ?>
    <!--#Meta:modules/editor/skins/sejin7940_editor_blank/css/black.css--><?php $__tmp=array('modules/editor/skins/sejin7940_editor_blank/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<?php if($__Context->colorset == "white_texteditor" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "white_text_nohtml" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "white_text_usehtml" || $__Context->colorset == "black_text_usehtml"){ ?>
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/sejin7940_editor_blank/js/xe_textarea.js--><?php $__tmp=array('modules/editor/skins/sejin7940_editor_blank/js/xe_textarea.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
	<?php if(!__DEBUG__){ ?><!--#Meta:modules/editor/skins/sejin7940_editor_blank/js/xe_textarea.min.js--><?php $__tmp=array('modules/editor/skins/sejin7940_editor_blank/js/xe_textarea.min.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
...
<?php }else{ ?>
	...
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/sejin7940_editor_blank/js/Xpress_Editor.js--><?php $__tmp=array('modules/editor/skins/sejin7940_editor_blank/js/Xpress_Editor.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/sejin7940_editor_blank/js/xe_interface.js--><?php $__tmp=array('modules/editor/skins/sejin7940_editor_blank/js/xe_interface.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
	<?php if(!__DEBUG__){ ?><!--#Meta:modules/editor/skins/sejin7940_editor_blank/js/xpresseditor.min.js--><?php $__tmp=array('modules/editor/skins/sejin7940_editor_blank/js/xpresseditor.min.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
    <!-- 자동저장용 폼 -->

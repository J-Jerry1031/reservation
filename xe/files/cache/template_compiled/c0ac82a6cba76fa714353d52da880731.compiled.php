    ...
    <?php if($__Context->list_config&&count($__Context->list_config))foreach($__Context->list_config as $__Context->key => $__Context->val){ ?>
        ...
        <?php if($__Context->val->idx == -1){ ?>
            ...
            <?php if($__Context->val->type == 'no'){ ?>
                <th scope="col" <?php echo $__Context->_lc ?>>
					<div><?php echo $__Context->lang->no ?></div>
				</th>
...
if($__Context->sort_index=='regdate'){ ?><img src="/xe/modules/board/skins/xe_board/images/common/<?php echo $__Context->order_icon ?>" alt="" width="5" height="3" class="sort" /><?php } ?></a></div></th>
...
if($__Context->sort_index=='last_update'){ ?><img src="/xe/modules/board/skins/xe_board/images/common/<?php echo $__Context->order_icon ?>" alt="" width="5" height="3" class="sort" /><?php } ?></a></div></th>
...
if($__Context->sort_index=='readed_count'){ ?><img src="/xe/modules/board/skins/xe_board/images/common/<?php echo $__Context->order_icon ?>" alt="" width="5" height="3" class="sort" /><?php } ?></a></div></th>
...
if($__Context->sort_index=='voted_count'){ ?><img src="/xe/modules/board/skins/xe_board/images/common/<?php echo $__Context->order_icon ?>" alt="" width="5" height="3" class="sort" /><?php } ?></a></div></th>
            <?php } ?>
        ...
        <tr class="notice">
            ...
            <?php if($__Context->list_config&&count($__Context->list_config))foreach($__Context->list_config as $__Context->key => $__Context->val){ ?>
                ...
                <?php if($__Context->val->idx == -1){ ?>
                    ...
                    <?php if($__Context->val->type == 'no'){ ?>
                        <td class="notice">
							<?php if($__Context->document->get('hot_document')){ ?>
								<span style="background-color: #ff0000;border-radius: 3px;color:#fff;padding: 2px;">화제 공지</span>
							<?php }elseif($__Context->document_srl == $__Context->document->document_srl){ ?><img src="/xe/modules/board/skins/xe_board/images/common/iconArrowD8.gif" border="0" alt="" />
							<?php }else{;
        ...
        <tr class="bg<?php echo ($__Context->no+1)%2+1 ?>">
            ...
            <?php if($__Context->list_config&&count($__Context->list_config))foreach($__Context->list_config as $__Context->key => $__Context->val){ ?>
                ...
                <?php if($__Context->val->idx == -1){ ?>
                    ...
                    <?php if($__Context->val->type == 'no'){ ?>
                        <td class="num"><?php if($__Context->document_srl == $__Context->document->document_srl){ ?><img src="/xe/modules/board/skins/xe_board/images/common/iconArrowD8.gif" border="0" alt="" /><?php }else{;
echo $__Context->no;
} ?></td>
                    <?php }elseif($__Context->val->type == 'title'){ ?>
                        <td class="title">

	  	...
	  	<div class="logo">
	  	  ...
	  	  <div class="menu">
	  	    <div class="h_menu4"><!-- start h_menu4 -->
				<a class="toggleMenu" href="#">Menu</a><div class="nav_icon"><img src="/xe/layouts/kbfree/images/nav_icon.png" alt=""/></div>
				<ul class="nav">
					...
					<script type="text/javascript" src="/xe/layouts/kbfree/js/nav.js"></script>
				</ul>
			</div><!-- end h_menu4 -->
            <div class="clearfix"> </div>
	  </div>

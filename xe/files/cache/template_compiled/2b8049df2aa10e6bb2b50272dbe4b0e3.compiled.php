...
if($__Context->sort_index=='regdate'){ ?><img src="/xe/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
...
if($__Context->sort_index=='last_update'){ ?><img src="/xe/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
...
if($__Context->sort_index=='readed_count'){ ?><img src="/xe/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
...
if($__Context->sort_index=='voted_count'){ ?><img src="/xe/modules/board/skins/xe_default/images/common/<?php echo $__Context->order_icon ?>" alt="sort" width="5" height="3" class="sort" /><?php } ?></a></th>
                        <?php } ?>
                    
                    <?php }else{ ?>
                            <th scope="col"><div><?php echo $__Context->val->name ?></div></th>
                    <?php } ?>
                <?php } ?>
            </tr>
        </thead>

...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/simple_board','_header.html') ?>
<?php if($__Context->oDocument->isExists()){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/simple_board','_read.html');
} ?>
...
<div class="list_footer">
	<?php if($__Context->document_list || $__Context->notice_list){ ?><div class="pagination">
		<a href="<?php echo getUrl('page','','document_srl','','division',$__Context->division,'last_division',$__Context->last_division) ?>" class="direction prev"><?php echo $__Context->lang->first_page ?></a> 
		...
		<?php } ?>
		<a href="<?php echo getUrl('page',$__Context->page_navigation->last_page,'document_srl','','division',$__Context->division,'last_division',$__Context->last_division) ?>" class="direction next"><?php echo $__Context->lang->last_page ?></a>
	</div><?php } ?>
	<div class="btnArea">
		<a href="<?php echo getUrl('act','dispBoardWrite','document_srl','') ?>" class="sbtn_a"><?php echo $__Context->lang->cmd_write ?></a>
		<?php if($__Context->grant->manager){ ?><a href="<?php echo getUrl('','module','document','act','dispDocumentManageDocument') ?>" onclick="popopen(this.href,'manageDocument'); return false;" class="sbtn_a"><?php echo $__Context->lang->cmd_manage_document ?></a><?php } ?>
	</div>
	<?php if($__Context->document_list || $__Context->notice_list){ ?><div class="btnArea2">
	<?php if($__Context->grant->view){ ?><form action="<?php echo getUrl() ?>" method="get" onsubmit="return procFilter(this, search)" id="board_search" class="board_search" ><input type="hidden" name="act" value="<?php echo $__Context->act ?>" />
		...
		<button type="submit" class="sbtn" onclick="xGetElementById('board_search').submit();return false;"><?php echo $__Context->lang->cmd_search ?></button>
        <?php if($__Context->last_division){ ?><a href="<?php echo getUrl('page',1,'document_srl','','division',$__Context->last_division,'last_division','') ?>"><?php echo $__Context->lang->cmd_search_next ?></a><?php } ?>
	</form><?php } ?>
<a href="<?php echo getUrl('act','dispBoardTagList') ?>" title="<?php echo $__Context->lang->tag ?>" class="sbtn_a"><?php echo $__Context->lang->tag ?></a>
	</div><?php } ?>
</div>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/simple_board','_footer.html') ?>

...
<form action="./" method="post" onsubmit="return procFilter(this, insert_comment)"  class="write_author" ><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
	...
	<input type="hidden" name="parent_srl" value="<?php echo $__Context->comment->comment_srl ?>" />
    <div style="padding:10px 0;">
	<div class="sm-input-body">
    
    <input type="text" name="content" style="width:70%;background:#FFF"  value=""  />
    ...
    <a href="#" onclick="toggle_object('reply_<?php echo $__Context->comment->comment_srl ?>'); return false;" title="<?php echo $__Context->lang->cmd_cancel ?>" class="sm-btn-de"><?php echo $__Context->lang->cmd_cancel ?></a>
</div>

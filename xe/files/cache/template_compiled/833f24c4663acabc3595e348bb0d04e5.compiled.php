<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/pointrush/skins/default/css/board.default.css--><?php $__tmp=array('modules/pointrush/skins/default/css/board.default.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/pointrush/skins/default/js/board.default.js--><?php $__tmp=array('modules/pointrush/skins/default/js/board.default.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--
		<?php if($__Context->grant->manager){ ?><a class="setup" href="<?php echo getUrl('act','dispPointrushAdminPointrushInfo') ?>" title="<?php echo $__Context->lang->cmd_setup ?>"><?php echo $__Context->lang->cmd_setup ?></a><?php } ?>
-->
	</div><?php } ?>
	<?php if($__Context->module_info->use_category=='Y'){ ?><ul class="cTab">
		<li<?php if(!$__Context->category){ ?> class="on"<?php } ?>><a href="<?php echo getUrl('','mid',$__Context->mid) ?>"><?php echo $__Context->lang->all ?></a></li>

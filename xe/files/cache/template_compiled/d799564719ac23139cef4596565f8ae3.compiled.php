...
<table class="x_table x_table-striped x_table-hover">
	...
	<tbody>
		<?php if($__Context->member_list&&count($__Context->member_list))foreach($__Context->member_list as $__Context->no=>$__Context->val){ ?><tr>
			...
			<td><a href="#popup_menu_area" class="member_<?php echo $__Context->val->member_srl ?>"><img src="http://www.goggg.co.kr/xe/modules/point/icons/warrock_17x17/<?php echo $__Context->val->level ?>.gif" height="15"><?php echo $__Context->val->nick_name ?></a></td>
			<td>
				<form action="./" method="get" style="margin:0"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
					...
					<input type="text" name="orgpoint" value="<?php echo $__Context->val->point ?>" disabled="disabled" style="width:80px;text-align:right" />
					-&gt;
					<span class="x_input-append">
						<input type="number" id="point_<?php echo $__Context->val->member_srl ?>" value="<?php echo $__Context->val->point ?>" name="point" required style="width:85px;text-align:right" />

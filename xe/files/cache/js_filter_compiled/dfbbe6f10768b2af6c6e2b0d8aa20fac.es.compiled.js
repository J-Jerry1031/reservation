function move_friend(form){ return legacy_filter('move_friend', form, 'communication', 'procCommunicationMoveFriend', filterAlertMessage, [], '¿Está seguro que desea mover?', {}) };
(function($){

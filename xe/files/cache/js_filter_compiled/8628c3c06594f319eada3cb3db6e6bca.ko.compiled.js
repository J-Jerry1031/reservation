function insert(form){ return legacy_filter('insert', form, 'pointrush', 'procPointrushInsertDocument', completeDocumentInserted, ['error','message','mid','document_srl','category_srl'], '', {}) };
(function($){

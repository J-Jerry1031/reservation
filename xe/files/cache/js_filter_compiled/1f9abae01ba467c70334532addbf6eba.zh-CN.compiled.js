function fix_attendance_data(form){ return legacy_filter('fix_attendance_data', form, 'attendance', 'procAttendanceAdminFixAttendanceData', filterAlertMessage, ['error','message'], '确定要提交吗?', {}) };
(function($){

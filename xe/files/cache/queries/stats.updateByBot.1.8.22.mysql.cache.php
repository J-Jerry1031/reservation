...
${'bot_count2_argument'} = new Argument('bot_count', $args->{'bot_count'});
${'bot_count2_argument'}->setColumnOperation('+');
${'bot_count2_argument'}->ensureDefaultValue(1);
if(!${'bot_count2_argument'}->isValid()) return ${'bot_count2_argument'}->getErrorMessage();
if(${'bot_count2_argument'} !== null) ${'bot_count2_argument'}->setColumnType('number');
...
,new UpdateExpression('`bot_count`', ${'bot_count2_argument'})
));

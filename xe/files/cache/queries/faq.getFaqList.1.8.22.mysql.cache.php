...
if(isset($args->s_module)) {
${'s_module3_argument'} = new ConditionArgument('s_module', $args->s_module, 'equal');
${'s_module3_argument'}->createConditionValue();
if(!${'s_module3_argument'}->isValid()) return ${'s_module3_argument'}->getErrorMessage();
} else
${'s_module3_argument'} = NULL;if(${'s_module3_argument'} !== null) ${'s_module3_argument'}->setColumnType('varchar');
...
new ConditionWithoutArgument('`module`',"'faq'","equal")))
,new ConditionGroup(array(
...
,new ConditionWithArgument('`module`',$s_module3_argument,"equal", 'or')

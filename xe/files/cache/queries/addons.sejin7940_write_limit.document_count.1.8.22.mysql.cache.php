...
$query = new Query();
$query->setQueryId("document_count");
...
new ConditionWithoutArgument('`documents`.`module_srl`','`modules`.`module_srl`',"equal")
,new ConditionWithoutArgument('`modules`.`module`',"'board'","equal", 'and')
,new ConditionWithArgument('`documents`.`member_srl`',$member_srl1_argument,"equal", 'and')
,new ConditionWithArgument('`documents`.`ipaddress`',$ipaddress2_argument,"equal", 'and')
,new ConditionWithArgument('`documents`.`regdate`',$limit_start3_argument,"more", 'and')
,new ConditionWithArgument('`documents`.`module_srl`',$limit_module_srl4_argument,"in", 'and')))
));

<?php
    ...
    if($called_position == 'after_module_proc' && Context::getResponseMethod()!="XMLRPC") {
		...
		if($document_srl){
			...
			if($addon_info->display_voted=='N') Context::addHtmlFooter("<script type=\"text/javascript\"> jQuery(document).ready(function() { jQuery('.btn_voted').css('display','none'); });</script>");
			if($addon_info->display_blamed=='N') Context::addHtmlFooter("<script type=\"text/javascript\"> jQuery(document).ready(function() { jQuery('.btn_blamed').css('display','none'); });</script>");
			if($addon_info->display_declared!='Y') Context::addHtmlFooter("<script type=\"text/javascript\"> jQuery(document).ready(function() { jQuery('.btn_declared').css('display','none'); });</script>");
